...
class ChaUserAgentMiddleware(object):
    ...
    #
    #     request.headers.setdefault('Host', 'twitchtracker.com')
    #
    #     request.headers.setdefault('Referer', 'https://twitchtracker.com/')
    def process_request(self, request, spider):
        if spider.name == "channelsSpi":
            ...
            origin_code = spider.bro.page_source
